...
void ImporterMesh::CleanUp()
{
	aiDetachAllLogStreams();
}

void ImporterMesh::Import(const aiMesh* aimesh, ResourceMesh* mesh)
{
	Timer timer;
	timer.Start();
...
uint64 ImporterMesh::Save(ResourceMesh* mesh, char** fileBuffer)
{
...
bool ImporterMesh::Load(char* fileBuffer, ResourceMesh* mesh, uint size)
{
	bool ret = true;
